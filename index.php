				...
				<div class="row">
					<div class="col">
						<div class="home_content text-center">
							...
							<div class="home_title"><h1>Не самый обычный опыт...</h1></div>
							<div class="home_text ml-auto mr-auto">
								<p>Мы предоставляем возможность поужинать в одной из самых высоких башен нашего города. Насладитесь прекрасным видом, а также восхитительной едой. Только в Маленькой Италии!</p>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="row">
				<div class="col">
					<div class="intro_content">
						<div class="intro_subtitle page_subtitle">Contigo pan y cebolla</div>
						<div class="intro_title"><h2>Ощутите вкус жизни</h2></div>
						<div class="intro_text">
							<p>Наши повора, посвятившие жизнь искусству сотворения шедевров испанской кухни, готовы открыть для вас мир совершенно новых вкусов. Зачем ждать? Забронируйте столик уже сегодня!</p>
						</div>
					</div>
					<div class="row">
