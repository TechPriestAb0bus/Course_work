...
<div class="super_container">
                        ...
                        <nav class="main_nav">
                            <ul class="d-flex flex-row align-items-center justify-content-start">
                                ...
                                if (isset($_SESSION['user'])) {
                                    ...
                                    echo '<li><a href="cart.php.php">Корзина</a></li>';
    ...
    <div class="menu trans_800">
        ...
        <div class="menu_reservations_phone ml-auto">Брон: +7 999 999 9999</div>
    </div>
                ...
                <div class="row themenu_row">
                            ...
                            <div class="dish_list">
								...
								<div class="dish_contents">
									<ul class="d-flex flex-row align-items-start justify-content-start flex-wrap">
										<li style="color: #FFFFFF">'.$_SESSION['dish'.$i]['description'].'</li>
									</ul>
								</div>
                    ...
                    <div class="parent">
                        <form class="login_form" action="templates/auth/config/signin.php" method="post">
                            <?php
                            $user_id_ord = $_SESSION['user']['id'];
                            $check_status_number = mysqli_query($connect, "SELECT * FROM `status_order` WHERE `user_id` = '$user_id_ord'");
                            $status_number_ord = mysqli_fetch_assoc($check_status_number);
                            $_SESSION['status_number_ord'] = [
                                "status_number" => $status_number_ord['status_number'],
                            ];
                            $number_ord = $_SESSION['status_number_ord']['status_number'];
                            if ($number_ord < 10){
                                $number_ord = "00".$number_ord;
                            }
                            elseif (10 < $number_ord and $number_ord < 100){
                                $number_ord = "0".$number_ord;
                            }
                            echo '<h2 class="cart_status">Номер заказа: '.$number_ord.'</h2>';
                            ?>
                            <h2 style="color: #FFFFFF">Статус: Принят <? ?></h2>
                            <h2 style="color: #FFFFFF">Итог: ₽<? echo $ultimate_coast?></h2>
                        </form>
                    </div>
                </div>
            </div>
