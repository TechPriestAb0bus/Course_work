...
<div class="super_container">
                    ...
                    <div class="header_content d-flex flex-row align-items-center justify-content-start">
                        ...
                        <nav class="main_nav">
                            <ul class="d-flex flex-row align-items-center justify-content-start">
                                ...
                                <li><a href="adder.html">Добавление блюд</a></li>
                                <li><a href="chose.html">Выбор блюда дня</a></li>
    ...
    <div class="home">
        ...
        <div class="parent">
            <form class="login_form" action="templates/auth/config/menu_adder.php" method="post">
                <label class="login_label">Тип</label>
                <select class="adder_select" name="type">
                    <option value="starter">Закуски</option>
                    <option value="main">Основное блюдо</option>
                    <option value="desert">Десерт</option>
                </select>
                <label class="login_label">Название</label>
                <input class="login_input" type="text" name="name" placeholder="Введите название блюда">
                <label class="login_label">Цена</label>
                <input class="login_input" type="number" name="coast" placeholder="Введите цену">
                <label class="login_label">Описание</label>
                <input class="login_input" type="text" name="description" placeholder="Введите описание (1000 символов макс)">
                <button class="login_button" type="submit">Добавить блюдо</button>
                <?php
                if (isset($_SESSION['message'])) {
                    if ($_SESSION['message'] === 'Блюдо успешно создано!') {
