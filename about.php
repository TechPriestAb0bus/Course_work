				...
				<div class="row">
					<div class="col">
						<div class="home_content text-center">
							<div class="home_subtitle page_subtitle">Little Italy is...</div>
			...
			<div class="row">
				<div class="col">
					<div class="intro_content">
						<div class="intro_subtitle page_subtitle">Нечто новое</div>
						<div class="intro_title"><h2>Необычный Опыт</h2></div>
			...
			<div class="row">
				<div class="col">
					<div class="section_title_container">
						<div class="section_subtitle page_subtitle">Нечто новое</div>
						<div class="section_title"><h1>Познакомьтесь с Шефами</h1></div>
					</div>
				</div>
			</div>
			<div class="row chefs_text_row">
				<div class="col-lg-6">
					<div class="chefs_text">
						<p>А теперь давайте поговорим о тех, кто творит всю закулисную магию. Именно они творят то, чем позже вы будете наслаждаться.</div>
				</div>
				<div class="col-lg-6">
					<div class="chefs_text">
						<p>Итак, встречайте - единственные, неповторимые, любимые - наши повора!</p>
					</div>
				</div>
			</div>
			<div class="row chefs_row row-eq-height">
				...
				<div class="col-xl-3 col-md-6 chef_col d-flex flex-column align-items-center justify-content-end">
					<div class="chef">
						...
						<div class="chef_content text-center">
							<div class="chef_name">Мария Кузнецова</div>
							<div class="chef_subtitle">Топ-шеф</div>
							<div class="chef_button ml-auto mr-auto trans_400"><a href="#">узнайте больше</a></div>
						</div>
					</div>
				</div>
				...
				<div class="col-xl-3 col-md-6 chef_col d-flex flex-column align-items-center justify-content-end">
					<div class="chef">
						...
						<div class="chef_content text-center">
							<div class="chef_name">Валерий Петров</div>
				...
				<div class="col-xl-3 col-md-6 chef_col d-flex flex-column align-items-center justify-content-end">
					<div class="chef">
						...
						<div class="chef_content text-center">
							<div class="chef_name">Юлий Петров</div>
				...
				<div class="col-xl-3 col-md-6 chef_col d-flex flex-column align-items-center justify-content-end">
					<div class="chef">
						...
						<div class="chef_content text-center">
							<div class="chef_name">Ксения Сидорова</div>
							<div class="chef_subtitle">Су-шеф</div>
							<div class="chef_button ml-auto mr-auto trans_400"><a href="#">узнайте больше</a></div>
						</div>
					</div>
		...
		<div class="container">
			<div class="row">
				<div class="col text-center">
					<div class="section_title_container">
						<div class="section_subtitle page_subtitle">Что они говорят</div>
						<div class="section_title"><h1>Рекомендации</h1></div>
					</div>
				</div>
			</div>
					...
					<div class="test_slider_container">
						<div class="owl-carousel owl-theme test_slider">
							...
							<div class="owl-item text-center">
								...
								<div class="test_info">Апчихбах Васильев, <span>Клиент</span></div>
							</div>
						</div>
					</div>
				</div>
